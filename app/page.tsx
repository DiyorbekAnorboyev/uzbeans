          ...
          <div className="relative flex flex-col justify-between h-screen pb-10 z-10">
                  ...
                  {isOpen && (  // Show dropdown content if menu is open
                    <DropdownMenuContent className="w-auto bg-green-500">
                      <div className="flex flex-col space-y-4 text-xl">
                        <DropdownMenuCheckboxItem onClick={() => handleLanguageChange('ru')} className="px-4 py-1 hover:cursor-pointer">RUS</DropdownMenuCheckboxItem>
                        <DropdownMenuCheckboxItem onClick={() => handleLanguageChange('en')} className="px-4 py-1 hover:cursor-pointer">ENG</DropdownMenuCheckboxItem>
                      </div>
                    </DropdownMenuContent>
                  )}
                </DropdownMenu>
                    ...
                    {isOpenMenu && (  // Show dropdown content if menu is open
                      <DropdownMenuContent className="w-auto bg-green-500">
                        <div className="flex flex-col space-y-4">
                          <div className="sm:hidden px-4 py-2 hover:cursor-pointer">{t('main')}</div>
                          <div className="sm:hidden px-4 py-2 hover:cursor-pointer">{t('about')}</div>
                          <div className="sm:hidden px-4 py-2 hover:cursor-pointer">{t('catalog')}</div>
            ...
            <div className="flex flex-col text-white md:flex-row justify-between items-center px-6 sm:px-10 md:px-20 mt-12">
              <div className="md:pl-10 text-center md:text-left">
                <p className="text-2xl sm:text-3xl font-bold">{t('main_bob')}</p>
              ...
              <div className="mt-6 md:mt-0 flex items-center rounded bg-opacity-10">
                <div className="flex items-center gap-4 px-4 py-2 rounded-full bg-white bg-opacity-40 sm:rounded-l-full">
                  ...
                  <div className="text-sm sm:text-base">{t('download_catalog')}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row mt-10 md:mt-20 gap-10 md:gap-20 pb-20">
          ...
          <div className="w-full">
            ...
            <p className="mt-6 sm:mt-10 text-base sm:text-xl md:text-2xl">
              <span className="font-bold">{t('welcome_cm')}</span> — {t('txt_moldu')}<br />
              <span className="font-bold">{t('txt_upakov')}</span>, {t('txt_cozdat')}
            </p>
            <div className="mt-6 sm:mt-10 text-base sm:text-xl md:text-2xl">
              <p>
                <span className="font-bold">{t('txt_uspexa')}</span> — {t('txt_sochet')}
              </p>
            </div>
          ...
          <div className="mt-32 sm:mt-40 px-6 sm:px-10 md:px-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            ...
            <div className="lg:col-span-2 bg-slate-400 relative shadow-lg overflow-hidden h-56 sm:h-64">
              ...
              <div className="absolute bottom-0 left-0 w-full h-52 bg-gradient-to-t from-green-900 via-transparent to-transparent flex items-end justify-start">
                <p className="text-white text-lg font-bold px-4 py-2">{t('txt_nohot')}</p>
              </div>
            </div>
            ...
            <div className="bg-slate-600 relative shadow-lg overflow-hidden h-56 sm:h-64">
              ...
              <div className="absolute bottom-0 left-0 w-full h-52 bg-gradient-to-t from-green-900 via-transparent to-transparent flex items-end justify-start">
                <p className="text-white text-lg font-bold px-4 py-2">{t('txt_lovia')}</p>
              </div>
            </div>
            ...
            <div className="bg-slate-400 relative shadow-lg overflow-hidden h-56 sm:h-64">
              ...
              <div className="absolute bottom-0 left-0 w-full h-52 bg-gradient-to-t from-green-900 via-transparent to-transparent flex items-end justify-start">
                <p className="text-white text-lg font-bold px-4 py-2">{t('txt_yongoq')}</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 bg-slate-600 relative shadow-lg overflow-hidden h-56 sm:h-64">
              ...
              <div className="absolute bottom-0 left-0 w-full h-52 bg-gradient-to-t from-green-900 via-transparent to-transparent flex items-end justify-start">
                <p className="text-white text-lg font-bold px-4 py-2">{t('txt_yong')}</p>
              </div>
            </div>
          </div>
      ...
      <div>
        <div className="h-screen">
          <div className="px-6 md:px-20 h-1/2 bg-white">
            <div>
              <p className=" text-3xl md:text-4xl text-green-900 font-bold text-center md:text-left">{t('location')}
              </p>
            </div>
            <div className="w-full">
          ...
          <div className="w-full px-6 md:px-20 pt-10 contact-card">
            <h3 className="font-bold text-2xl md:text-3xl">{t('txt_contacts')}</h3>
            <div className="text-lg md:text-xl">
              <div className="flex flex-col md:flex-row mt-5 justify-between items-center">
                ...
                <p className="flex gap-3 mt-3 md:mt-0 text-sm md:text-base"><Map size={22} className="hover:cursor-pointer" /> {t('loc_main')} <br /></p>
              </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <p className="text-sm md:text-base"> {t('loc_second')} <br /></p>
              </div>
            </div>
            <h4 className="font-bold mt-5 text-2xl md:text-3xl"> {t('txt_sotvi')}</h4>
